  ...
  return (
    <main className="pt-12 h-screen flex flex-col items-center bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800">
      <div className="w-full flex-grow flex flex-col group">
        <section className="grid grid-rows-3 lg:grid-rows-none lg:grid-cols-7 justify-items-center pl-2 lg:pl-0 transition-all duration-600 ease-in-out hover:opacity-100">
        ...
        <nav className="w-full flex-grow flex flex-col lg:grid lg:grid-cols-home justify-between lg:justify-items-center mt-6 lg:mt-36 items-start text-white font-bold transition-all duration-700 ease-in-out">
          ...
          <div className="text-4xl lg:text-6xl self-start lg:self-auto lg:relative pl-2 lg:px-6 lg:py-2 group/dev lg:group-hover:bg-blue-700 duration-700">
            ...
            <div className="lg:absolute mt-4 lg:mt-0 lg:left-0 pr-2 lg:px-8 lg:py-4 lg:rounded text-base lg:opacity-0 lg:group-hover/dev:opacity-100 lg:group-hover/dev:bg-blue-700 duration-700 ease-in-out font-mono text-justify">
              <div className="mb-4">
                {
                  "I'm a developer with a passion for building things that live on the web. I enjoy working with JavaScript and have a soft spot for React. I also have experience working with Node.js, Express, and MongoDB. Copilot ftw cos it wrote this. I can :"
                }
              </div>
          ...
          <div className="text-4xl lg:text-6xl self-end lg:self-auto lg:relative pl-2 lg:px-6 lg:py-2 pb-8 lg:block group/teach lg:group-hover:bg-blue-700 duration-700">
            <div className="lg:flex lg:flex-row">
              ...
              <span className="lg:opacity-0 group-hover:opacity-100 transition-all duration-1000 ease-in-out lg:text-3xl xl:text-4xl text-4xl font-slab font-semibold tracking-wide pl-6 lg:pl-0 lg:ml-4">
                {'language teacher'}
              </span>
            </div>
            <div className="lg:absolute mt-4 lg:mt-0 lg:left-0 pr-2 lg:px-8 lg:py-4 lg:rounded text-base lg:opacity-0 lg:group-hover/teach:opacity-100 lg:group-hover/teach:bg-blue-700 duration-700 ease-in-out font-slab font-medium antialiased tracking-wider leading-relaxed text-justify">
              <div className="mb-4">
                {
                  "I'm a developer with a passion for building things that live on the web. I enjoy working with JavaScript and have a soft spot for React. I also have experience working with Node.js, Express, and MongoDB. Copilot ftw cos it wrote this. I can :"
                }
              ...
              <div className="flex flex-row justify-between">
                <div className="grow grid grid-rows-2 grid-cols-3 lg:grid-rows-3 lg:grid-cols-2 place-items-stretch">
                  ...
                  <div>Teaching</div>
                  <div>Teaching</div>
                  <div>Teaching Admin</div>
                  <div>Research</div>
                  <div>Learning</div>
                </div>
                <div className="flex flex-row items-center pr-4">
                  <span className="bg-blue-600 p-4 rounded font-mono font-bold">
                    . . .
                  </span>
                </div>
              </div>
