...
export default function IntroTitle() {
  ...
  return (
    <section className="mt-8 lg:mt-4 flex flex-row lg:grid lg:grid-rows-none lg:grid-cols-7 xl:gap-12 justify-items-center pl-2 lg:pl-0 transition-all duration-600 ease-in-out hover:opacity-100">
      ...
      <span className="lg:justify-self-start self-end 2xl:justify-self-start text-2xl lg:text-4xl font-bold text-white lg:opacity-0 group-hover:opacity-100 duration-1000 ease-in-out lg:col-start-6 2xl:col-start-5 lg:col-span-2 2xl:col-auto">
        {t('and')}
      </span>
    </section>
  );
