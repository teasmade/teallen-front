    ...
    <div className="mx-2 mb-4 lg:mt-0 font-mono font-bold">
      ...
      <div className="gap-6 lg:gap-0 grid grid-cols-7 justify-around mt-4">
        ...
        <div className="flex flex-row col-start-5 col-end-8 justify-end items-center self-end -mr-2 lg:mr-0">
          <span className="bg-sky-600 py-4 px-2 rounded text-[0.8rem] xl:text-base hover:scale-110 hover:-translate-x-2 ease-in duration-[150ms] underline lg:no-underline hover:underline hover:cursor-pointer hover:bg-sky-900 font-sans font-bold antialised">
            {t('btn-cta')}
          </span>
        </div>
      </div>
