...
export default function Skills() {
  ...
  return (
    <section className="w-full flex-grow flex flex-col justify-around lg:grid lg:grid-cols-home lg:justify-items-center mt-2 2xl:mt-4 items-start text-white font-bold transition-all duration-700 ease-in-out">
      ...
      <div className="text-4xl lg:text-6xl self-start lg:self-auto lg:relative pl-2 lg:px-6 lg:py-2 group/dev lg:bg-sky-700 duration-700 mb-4 lg:mb-0">
        <div className="lg:flex lg:flex-row-reverse flex flex-row justify-between bg-sky-700 lg:bg-transparent -ml-2 pl-2 lg:pl-0 lg:ml-0">
          ...
          <span className="lg:opacity-100 group-hover:opacity-100 duration-1000 ease-in-out lg:text-2xl lg:leading-tight xl:text-3xl 2xl:text-4xl text-xl pr-4 font-mono pl-6 lg:pl-0">
            {t('dev.title')}
          </span>
        </div>
        ...
        <div className="text-sm lg:text-base lg:absolute mt-4 lg:mt-0 lg:left-0 pr-2 lg:px-8 lg:py-4 lg:rounded text-[0.775rem] lg:text-base lg:opacity-100 lg:bg-sky-700 duration-[950ms] ease-in font-sans font-medium antialised mb-16 lg:mb-0">
      ...
      <div className="hidden lg:block py-2 w-full text-6xl bg-sky-700 text-center lg:opacity-100 group-hover:opacity-100 duration-700">
        <span className="opacity-0">*</span>
      </div>

      {/* Teach subtitle */}

      <div className="text-4xl lg:text-6xl self-end lg:self-auto lg:relative pl-2 lg:px-6 lg:py-2 pb-4 lg:block group/teach lg:bg-sky-700 duration-700 lg:max-h-[76px]">
        <div className="lg:flex lg:flex-row flex flex-row justify-between bg-sky-700 lg:bg-transparent -ml-2 pl-2 lg:pl-0 lg:ml-0">
          ...
          <span className="lg:opacity-100 group-hover:opacity-100 transition-all duration-1000 ease-in-out lg:leading-tight lg:text-2xl xl:text-3xl 2xl:text-4xl text-xl font-slab font-semibold tracking-wide pr-4 lg:pr-2 lg:pl-0 lg:ml-4">
            {t('teach.title')}
          </span>
        </div>
        ...
        <div className="lg:max-w-[475px] xl:max-w-full lg:absolute mt-4 lg:mt-0 lg:left-0 pr-2 lg:px-8 lg:py-4 lg:rounded text-sm lg:text-base lg:opacity-100 lg:group-hover/teach:opacity-100 lg:bg-sky-700 duration-[950ms] ease-in font-sans font-medium antialiased mb-12 lg:mb-0">
